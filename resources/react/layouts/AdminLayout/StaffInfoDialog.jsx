...
import { Box, Button, Dialog, DialogContent, DialogTitle, IconButton, TextField, capitalize } from "@mui/material";
...
export const StaffInfoDialog = () => {
  ...
  const { isOpenStaffInfoDialog, setIsOpenStaffInfoDialog } = useContext(AdminLayoutContext);
  ...
  return (
    <Dialog open={isOpenStaffInfoDialog} onClose={onClose} fullWidth={true} maxWidth="sm">
      <Box
        sx={{
          display: "flex",
          alignItems: "center",
          ...
          >
            <Box
              ...
              sx={{
                ...
                background: convertHex2Rgba(theme.palette.primary.main, 0.1),
                transition: "all 0.1s linear",
                borderBottom: "1px solid " + theme.palette.grey[500],
                "&:hover": {
                  background: convertHex2Rgba(theme.palette.primary.main, 0.05),
                },
                "&.active": {
                  background: "white",
