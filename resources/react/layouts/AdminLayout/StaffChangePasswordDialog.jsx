...
export const StaffChangePasswordDialog = () => {
  ...
  const { isOpenChangePasswordDialog, setIsOpenChangePasswordDialog } = useContext(AdminLayoutContext);
  ...
  return (
    <Dialog open={isOpenChangePasswordDialog} onClose={onClose} fullWidth maxWidth="sm">
      <Box
        sx={{
          display: "flex",
          alignItems: "center",
      ...
      >
        <DialogTitle>{capitalize(__("custom.change-password-title"))}</DialogTitle>
